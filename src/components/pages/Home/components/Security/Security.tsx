  ...
  <section>
    ...
    >
        ...
        >
          ...
          >
            ...
            <div css={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              ...
              <span css={{ fontSize: 16, color: '#101111' }}>
                OneKey uses industry-leading encryption technology to store your
                information locally. Only you can decrypt that information.
              </span>
            </div>
          </div>
        </div>
      ...
      <div css={{ display: 'flex' }}>
        <img alt="sideImage.png" src={placeholderImage} css={{ width: 633 }} />
      </div>
    </div>
  </section>
);
